...
export default function Payment() {
  ...
  return (
    <>
      {ticketDetails&&services&&<><div className="navbar">
                      ...
                      <div className="modal-body">
                        <table className="table table-hover table-bordered table-dark">
                          <tbody>
                            <tr>
                              <th>Ticket ID</th>
                              <td>{ticketDetails && ticketDetails.existTicket._id}</td>
                            </tr>
                            <tr>
                              <th>In Time</th>
                              <td>{ticketDetails && ticketDetails.existTicket.inTime.substring(0, 10) + " " + ticketDetails.existTicket.inTime.substring(11, 19)}</td>
                            </tr>

                            <tr>
                              <th>Services</th>
                              <td>{services && services.map(item => {
                                return <li>{item}</li>;
                              })}</td>
                            </tr>
                          </tbody>
